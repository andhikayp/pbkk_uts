...
<nav class="breadcrumb bg-white push">
    ...
    <span class="breadcrumb-item active">Tambah Stok Barang</span>
</nav>
<div class="block">
    <div class="block-header block-header-default bg-primary">
        <h3 class="block-title">Tambah Stok Barang</h3>
    </div>
    <div class="block-content">
        <form class="js-validation-bootstrap px-30" method="POST" enctype="multipart/form-data" action="{{ base_url('BarangController/saveStokBarang') }}" aria-label="">
            ...
            <div class="form-group row">
                <div class="col-12">
                    <div class="form-material form-material-primary floating input-group">
                        ...
                        <label for="username">Tambah Stok</label>
                        <div class="input-group-append">
                            <span class="input-group-text">Contoh: 80</span>
                        </div>
                    </div>
                </div>
            </div>
